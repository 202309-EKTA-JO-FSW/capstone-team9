...
const Footer = () => {
    return (
        <footer className="mt-3 px-10  bottom-0 left-0 w-full bg-white border-t border-gray-200 py-4 box-border flex justify-between items-center z-10">
            <div className="flex flex-col items-start gap-12">
                <div className='flex flex-col'>
                <Image className='mx-auto h-10 w-auto leading-9 mr-4' style={{ margin: '13px;'}} src={Icons.logo} alt="Eventure" />
